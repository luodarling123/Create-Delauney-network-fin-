function [bond_cor, node_cor, DeleteEdge, ThermalResistenceGradient ] = ...
    GreedyRandomdeletepar(bond_cor,node_cor, tem,maxboundarynode, minpose,maxpose)
...
parfor j = 1 : length(delete_index) 
    ...
    Temp_info_for_delete = CalculateTemperatureForOpt...
        (bond_test, node_cor, minpose, maxpose);
    ThermalResistenceGradient(j,:) = [(Temp_info_for_delete(1,2)-tem)/...
