...
file_dirname = 'F:\FEM\GraphAnalysis2\Optimiztion\symGraph\20_';
node_subname = '\nodes\';
edge_subname = '\edges\';
n = 794; %% 第n个，文件名为n-1
...
writematrix(bond_cor,'GreedyNetworkDeletebondcor_20_edge.txt');
writematrix(Size_info,'GreedyNetworkDeletebondcor_20_Size.txt');
writematrix(h_info,'GreedyNetworkDeletebondcor_20_havg.txt');
writematrix(Temp_info,'GreedyNetworkDeletebondcor_20_Temp.txt');
writematrix(Delete_Edge,'GreedyNetworkDeletebondcor_20_delete.txt');
