function [node_cor,bond_cor] = FunCreatesymGraph(n,bond,n_inside,Dis)
...
% 最小间距
minLeftTopBottomDistance = 0.08;
minRightDistance = 0.02;
minPointDistance = Dis;

% 生成随机点
points = zeros(numPoints/2, 2);

for i = 1:numPoints/2  %% 因为对称，只需要绘制1/2的内部点数量
    while true
        % 生成随机点坐标
