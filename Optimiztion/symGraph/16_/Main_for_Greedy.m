...
writematrix(bond_cor,'GreedyNetworkDeletebondcor_16_edge.txt');
writematrix(Size_info,'GreedyNetworkDeletebondcor_16_Size.txt');
writematrix(h_info,'GreedyNetworkDeletebondcor_16_havg.txt');
writematrix(Temp_info,'GreedyNetworkDeletebondcor_16_Temp.txt');