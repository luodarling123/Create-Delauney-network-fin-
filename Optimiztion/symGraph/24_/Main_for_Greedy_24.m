...
% Main_for_Greedy_24.m

% Start MATLAB's parallel computing pool with the desired number of workers
%numWorkers = 12;  % Specify the number of workers (cores) you want to use
...
file_dirname = '/data/home/duanfuqing/LTL/Matlab/Optimiztion/symGraph/24_';
node_subname = '/nodes/';
edge_subname = '/edges/';
n = 41; %% 第n个，文件名为n-1
...
writematrix(bond_cor,'GreedyNetworkDeletebondcor_24_edge.txt');
writematrix(Size_info,'GreedyNetworkDeletebondcor_24_Size.txt');
writematrix(h_info,'GreedyNetworkDeletebondcor_24_havg.txt');
writematrix(Temp_info,'GreedyNetworkDeletebondcor_24_Temp.txt');
